...
class ProductTransys(Transys):
    ...
    def get_maze(self, mazefile, int_1, int_2, int_3):
        self.maze = MazeNetwork(mazefile)
        self.maze.set_int_1_2_and_3(int_1, int_2, int_3)
    ...
    def get_APs(self):
        ...
        """
        self.AP = [spot.formula.ap("goal"), spot.formula.ap("int_1"), spot.formula.ap("int_2"), spot.formula.ap("int_3")]
        self.AP_dict = od()
        for s in self.S: # If the system state is the init or goal
            ...
            elif s == self.maze.int_3:
                self.AP_dict[s].append(spot.formula.ap("int_3"))
    ...
    def construct_sys(self, mazefile):
        ...
        int_2 = (3,0)
        int_3 = (1,4)
        self.get_maze(mazefile, int_1, int_2, int_3)
