'''
Solving empty grids of different sizes with one intermediate node using the MILP for reactive obstacles.
'''
...
def plot_runtimes(runtimes):
    ...
    fig.savefig("imgs/reactive_runtimes_1_int.pdf")
    plt.show()
...
if __name__ == '__main__':
    ...
    if save_solutions:
        ...
        filename = 'runtimes/reactive_1_int_' + now + '.pkl'
