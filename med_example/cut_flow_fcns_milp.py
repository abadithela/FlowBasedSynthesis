...
from feasibility_constraints import add_feasibility_constraints_for_each_q, add_static_obstacle_constraints
...
def solve_min(GD, SD):
    ...
    # model = advanced_feasibility_constraints(model, GD, SD)
    model = add_feasibility_constraints_for_each_q(model, GD, SD)
