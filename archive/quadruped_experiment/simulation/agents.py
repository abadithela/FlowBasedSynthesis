...
class Quadruped:
    ...
    def find_controller(self,maze,tester):
        ...
        env_prog = set()
        env_prog |= {'(X_t = 2 && Z_t = 1) || (X_t = 2 && Z_t = 3) || (X_t = 2 && Z_t = 5)'} # tester will eventually make space
        # tester can move up and down the middle column
        dynamics_spec = {'(Z_t = 6) -> X((Z_t = 6) ||(Z_t = 5))'}
        dynamics_spec |= {'(Z_t = 5) -> X((Z_t = 5) || (Z_t = 4) ||(Z_t = 6))'}
